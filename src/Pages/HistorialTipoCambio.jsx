...
export default function HistorialTipoCambio() {
  ...
  return (
    ...
    <>
      ...
      <MiniHero titulo="Historial de valor del dolar" descripcion="Archivo histórico (7 días) del tipo de cambio de referencia. Consulta valores pasados, datos oficiales actualizados." imgsrc={imgCambioDolarHero} id="titulo" />
